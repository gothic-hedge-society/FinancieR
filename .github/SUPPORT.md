# Getting help with FinancieR

Thanks for using FinancieR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/FinancieR/issues) to make sure the 
